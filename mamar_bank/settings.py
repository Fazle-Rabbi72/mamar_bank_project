...
# SECRET_KEY = 'django-insecure-)wxo!z_1is_&xp7^mo(v@74l$zlq+3#13ll6&-i&zu1bzs^ydp'

# SECURITY WARNING: don't run with debug turned on in production!
DEBUG = True

ALLOWED_HOSTS = ["*"]
CSRF_TRUSTED_ORIGINS = ['https://mamar-bank-project-gzub.onrender.com','https://*.127.0.0.1']
